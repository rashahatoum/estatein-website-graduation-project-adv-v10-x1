...
const StatCard = ({ value, desc }: IStats) => {
    return (
        <div className="bg-grey-10 w-full text-center xl:text-left xl:max-w-190 2xl:max-w-240 2xl:py-16 2xl:px-24 xl:px-20 xl:py-14 p-16 text-white rounded-lg xl:rounded-[10px] 2xl:rounded-xl border border-grey-15 transition-all duration-500 ease-in-out 
