...
const Navbar = () => {
  ...
  return (
    <nav className="bg-grey-10 light:bg-white-97">
      <div className="w-full 2xl:max-w-1696  px-16 md:px-50 xl:max-w-1380 relative flex justify-between items-center py-20 font-medium text-18 text-white light:text-grey-10 gap-10">
